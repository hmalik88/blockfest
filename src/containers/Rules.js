...
class Rules extends React.Component {
  ...
  render() {
    return(
      <>
      <div className='rule-logo-div'>
        <img src={blockFestLogo} alt='' className='rules-logo' />
      </div>
      <div className='rules-section'>
        <h2>Rules & Code of Conduct</h2>
        <p className='rule-paragraph'>
          BlockFest events are community hackathons intended for collaboration and learning in the developer community. We value the participation of each member of the community and want all attendees to have an enjoyable and fulfilling experience. Accordingly, all attendees are expected to show respect and courtesy to other attendees throughout the hackathon. To make clear what is expected, all attendees and speakers at this hackathon are required to conform to the following Code of Conduct. Organizers will enforce this code throughout the event.
        </p>
        <h4>The Code</h4>
        <p className='rule-paragraph'>
        ...
        <p className='rule-paragraph'>
          Sponsors, judges, mentors, volunteers, organizers, BlockFest staff and anyone else at the event are also subject to the anti-harassment policy. In particular, attendees should not use sexualized images, activities, or other material both in their hacks and during the event. Booth staff (including volunteers) should not use sexualized clothing/uniforms/costumes, or otherwise create a sexualized environment.
        </p>
        <p className='rule-paragraph'>
        ...
        <p className='rule-paragraph'>
          If you feel uncomfortable or think there may be a potential violation of the code of conduct, please report it immediately to one of the event organizers or by emailing us at <a className='rule-mail' href='mailto:info@blockfest.co'>info@blockfest.co</a>. All reporters have the right to remain anonymous.
        </p>
        <h4>Event Rules & Conditions</h4>
        <ol>
          <li>Please do not rearrange any furniture / layout on the premises, failure to comply may result in expulsion.</li>
          ...
          <li>You acknowledge that the organizers and sponsors of The Event, including the BlockFest (collectively, the “Organizers”) will be recording the The Event event on video, photographs, audio recording and other media, and therefore agree that:
            <ol>
          ...
          <li className='ninth-item'>
            ...
            <i>For valuable consideration, including permission to take part in The Event, the undersigned on behalf of him/herself, his or her personal representatives, assigns, heirs and next of kin:</i>
          </li>
