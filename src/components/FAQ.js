  ...
  render() {
    return(
      <>
        ...
        <Collapsible className='Q1' open={this.state.isOpen1} trigger='What is BlockFest NYC?'>
          <div className='A1'>
        ...
        <Collapsible className='Q2' open={this.state.isOpen2} trigger='Who can participate?' classParentString = 'Collapsible2'>
          <div className='A2'>
        ...
        <Collapsible className='Q3' open={this.state.isOpen3} trigger='How much does it cost to attend?' classParentString = 'Collapsible3'>
          <div className='A3'>
        ...
        <Collapsible className='Q4' open={this.state.isOpen4} trigger='Will Blockfest NYC offer travel scholarships to hackers?' classParentString='Collapsible4'>
          <div className='A4'>
        ...
        <Collapsible className='Q5' open={this.state.isOpen5} trigger='How many people can be on a team?' classParentString='Collapsible5'>
          <div className='A5'>
        ...
        <Collapsible className='Q6' open={this.state.isOpen6} trigger='What if I’ve never been to a hackathon or worked with blockchain technology before?' classParentString='Collapsible6'>
          <div className='A6'>
        ...
        <Collapsible className='Q7' open={this.state.isOpen7} trigger='Can I start working on my hack before the event?' classParentString='Collapsible7'>
          <div className='A7'>
